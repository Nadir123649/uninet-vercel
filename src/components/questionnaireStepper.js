...
const QuestionaireStepper = ({ activeStep, values, stepperList }) => {
  ...
  return (
    <div className={ishbrews == "he" ? "stepper-wrapper w-1/3 flex bg-primary-color py-5 rounded-md px-4 flex-row-reverse": "stepper-wrapper w-1/3 flex bg-primary-color py-5 rounded-md px-4"}>
